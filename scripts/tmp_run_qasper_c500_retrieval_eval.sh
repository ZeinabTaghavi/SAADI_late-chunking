...
printf 'Running QASPER c500 late-chunking retrieval grid:\n'
printf '  RETRIEVERS=%s\n' "${RETRIEVERS}"
...
printf 'Evaluating QASPER c500 retrieval runs:\n\n'
eval_index=0
...
printf 'Finished QASPER c500 rerun. failed_runs=%s total_steps=%s\n' \
  "${failed_runs}" \
